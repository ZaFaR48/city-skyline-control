...
const LITERALS: Record<string, [string, string]> = {
  ...
  "IP Reconciliation": ["Сверка IP Headscale", "Муқоисаи IP-и Headscale"],
  "Stored VPN": ["Сохранённый VPN", "VPN-и сабтшуда"],
  "Authoritative VPN": ["Авторитетный VPN", "VPN-и асосӣ"],
  "Online / last seen": ["Онлайн / последняя связь", "Онлайн / алоқаи охирин"],
  "Recommended action": ["Рекомендуемое действие", "Амали тавсияшуда"],
  "One-at-a-time action": ["Одиночное действие", "Амали якдафъаина"],
  "Refresh dry run": ["Обновить проверку", "Навсозии санҷиш"],
  "Refresh VPN": ["Обновить VPN", "Навсозии VPN"],
  "Replace node": ["Заменить узел", "Иваз кардани узел"],
  "Remove stale link": ["Удалить устаревшую связь", "Нест кардани пайванди кӯҳна"],
  "Confirm IP reconciliation": ["Подтвердить сверку IP", "Тасдиқи муқоисаи IP"],
  "Apply one action": ["Применить одно действие", "Татбиқи як амал"],
  "Old node / VPN": ["Старый узел / VPN", "Узели кӯҳна / VPN"],
  "New node / VPN": ["Новый узел / VPN", "Узели нав / VPN"],
  "OS / last seen": ["ОС / последняя связь", "СА / алоқаи охирин"],
  "station has no linked node": ["у станции нет связанного узла", "стансия узели пайваст надорад"],
  "linked node changed ip": ["IP связанного узла изменился", "IP-и узели пайваст тағйир ёфт"],
  "vpn ip duplicated": ["VPN IP дублируется", "VPN IP такрор шудааст"],
  "linked node missing": ["связанный узел отсутствует", "узели пайваст нест"],
  "several candidate nodes": ["несколько узлов-кандидатов", "якчанд узели эҳтимолӣ"],
  "device type is not station": ["тип устройства не станция", "навъи дастгоҳ стансия нест"],
  "approval missing": ["нет допуска узла", "тасдиқи узел нест"],
  "No action": ["Действие не требуется", "Амал лозим нест"],
  "Link an approved station node": [
    "Связать подтверждённый узел станции",
    "Пайвасти узели тасдиқшудаи стансия",
  ],
  "Refresh VPN from linked node": [
    "Обновить VPN из связанного узла",
    "Навсозии VPN аз узели пайваст",
  ],
  "Resolve the VPN conflict one station at a time": [
    "Устранить конфликт VPN по одной станции",
    "Ҳалли ихтилофи VPN барои ҳар стансия",
  ],
