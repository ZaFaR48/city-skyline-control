...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("viewer", "GET", "/api/reports/uptime.csv?start=2026-01-01T00:00:00Z&end=2026-01-02T00:00:00Z", None),
        ("viewer", "GET", "/api/reports/uptime.xlsx?start=2026-01-01T00:00:00Z&end=2026-01-02T00:00:00Z", None),
        ("operator", "GET", "/api/stations/health/diagnostics", None),
        ...
        ("operator", "POST", "/api/onboarding/stations/1/approve", {"preview_token": "x", "confirmation": "APPROVE STATION 1"}),
        ("viewer", "POST", "/api/onboarding/stations/1/approval-preview", None),
        ("viewer", "POST", "/api/onboarding/stations/1/revoke", {"preview_token": "x", "confirmation": "x"}),
        ("operator", "POST", "/api/registrations/1/link-preview", {"user_id": 1}),
        ("operator", "POST", "/api/registrations/1/link-existing", {"user_id": 1, "preview_token": "x", "confirmation": "x"}),
        ("operator", "POST", "/api/registrations/1/password-reset-preview", None),
        ("operator", "POST", "/api/registrations/1/password-reset", {"preview_token": "x", "confirmation": "x"}),
        ("viewer", "GET", "/api/onboarding/stations/by-code/10002", None),
